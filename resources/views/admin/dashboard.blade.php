...
@section('title', 'Tableau de bord Admin - GroundTech')

@section('content')
    <div class="space-y-6">
        <!-- En-tête du tableau de bord -->
        <div class="bg-white rounded-lg shadow-lg p-6">
            <h1 class="text-3xl font-bold text-blue-600">Tableau de bord Admin</h1>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <a href="#" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition duration-300">
                    ...
                    <span class="ml-3 text-gray-700">Gérer les utilisateurs</span>
                </a>
                <a href="#" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition duration-300">
                    <div class="p-2 rounded-full bg-blue-100 text-blue-600">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="ml-3 text-gray-700">Voir les rapports</span>
                </a>
                <a href="#" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition duration-300">
                    <div class="p-2 rounded-full bg-blue-100 text-blue-600">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">

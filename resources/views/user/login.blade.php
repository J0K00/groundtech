...
@section('title', 'Connexion Utilisateur - GroundTech')

@section('content')
    <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-blue-600">Connexion Utilisateur</h1>
        ...
        <div class="mt-6 text-center space-y-4">
            ...
            <div class="border-t border-gray-200 pt-4">
                ...
                <div class="flex justify-center space-x-4">
                    <a href="/engineer/login" class="text-sm text-blue-600 hover:text-blue-500">Ingénieur</a>
